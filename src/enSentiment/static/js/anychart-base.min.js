...
c.styleSheet?c.styleSheet.cssText=b:c.appendChild(window.document.createTextNode(String(b)));$.Xe($.De(window.document,"head",void 0,void 0)[0],c,0);NE=!0}this.Sd||(this.Sd=$.Oe("DIV","anychart-credits"));this.i||(this.i=$.Oe("A"),this.D=$.Oe("SPAN","anychart-credits-text"),this.b=$.Oe("IMG",""),Ve(this.i,this.D),this.Sd.appendChild(this.i));b=this.f.Pl();this.J(ml)&&(b&&b.appendChild(this.Sd),this.I(ml));this.J(nl)&&(b=$.ic.apply(null,[", v%s.%s.%s.%s"].concat(["8","11","0",
